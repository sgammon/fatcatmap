...
class ReligiousSect(Religion):
  ...
  def fixture(cls):
    ...
    ## -- christianity -- ##
    parent = christianity
    for label, additional, singular, plural, freebase, wikipedia in (
      ('Catholicism', ('Roman Catholic', 'Catholic Church'), 'Catholic', 'Catholics', '/m/0c8wxp', 'Catholicism'),
      ('Lutheranism', ('Lutheran Church',), 'Lutheran', 'Lutherans', '', 'Lutheranism'),
      ('Evangelicalism', ('Evangelical Christianity',), 'Evangelical', 'Evangelicals', '/m/02t7t', 'Evangelicalism'),
      ('Methodism', ('Methodist', 'Methodist Church'), 'Methodist', 'Methodists', '/m/051kv', 'Methodism'),
      ('Protestantism', ('Protestant Church',), 'Protestant', 'Protestants', '/m/05sfs', 'Protestantism'),
      ('Pentecostalism', ('Pentecostal Church',), 'Pentecostal', 'Pentecostals', '/m/05w5d', 'Pentecostalism'),
      ('Calvinism', ('Calvinist Church',), 'Calvinist', 'Calvinists', '/m/01t7j', 'Calvinism'),
      ('Baptists', ('Baptist Church',), 'Baptist', 'Baptists', '/m/019cr', 'Baptist'),
      ('Anglicanism', ('Anglican Church',), 'Anglican', 'Anglicans', '/m/0n2g', 'Anglicanism'),
      ('Anabaptists', ('Anabaptist Church',), 'Anabaptist', 'Anabaptists', '/m/01274', 'Anabaptists'),
      ('Adventist', ('Adventist Church',), 'Adventist', 'Adventists', '/m/025s83j', 'Adventism')):
    ...
    ## -- judaism -- ##
    orthodox = model.VertexKey(cls, 'orthodox', parent=judaism)
    classical = model.VertexKey(cls, 'classical', parent=judaism)
    ...
    for label, additional, singular, plural, parent, freebase, wikipedia in (
      ...
      ('Haredi', ('Haredi Judaism',), 'Haredi Jew', 'Haredi Jews', orthodox, '/m/0f2qf', 'Haredi_Judaism'),
      ('Hasidic', ('Hasidic Judaism',), 'Hasidic Jew', 'Hasidic Jews', orthodox, '/m/03r6w', 'Hasidic_Judaism'),
      ('Modern', ('Modern Orthodox Judaism',), 'Modern Orthodox Jew', 'Modern Orthodox Jews', orthodox, '/m/014j7r', 'Modern_Orthodox_Judaism'),
      ...
      ('Conservative', ('Conservative Judaism', 'Conservative Classical Judaism'), 'Conservative Classical Jew', 'Conservative Classical Jews', classical, '/m/01y7r', 'Conservative_Judaism'),
