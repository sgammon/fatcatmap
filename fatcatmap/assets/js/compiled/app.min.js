(function() {var e={"/":function(){this.a.c.$set("active",!0);this.a.c.$set("page.route","/");return null},"/login":function(){},"/settings":function(){},"/beta":function(a){console.log("request: ");console.log(a);this.a.c.$set("active",!0);this.a.c.$set("page.route","/beta");return null},"/404":function(){},"/<key>":function(){},"/<key1>/and/<key2>":function(){}};function k(a){if(a&&a.querySelector)return a;if("string"===typeof a){if("#"===a.charAt(0))a=document.getElementById(a.slice(1));else{a=document.querySelectorAll(a);var b=[],c;for(c=0;c<a.length;b.push(a[c++]));a=b}return a}throw new TypeError("Invalid document query string.");};var l={i:JSON.parse(k("#js-context").textContent||"{}"),data:JSON.parse(k("#js-data").textContent||"{}")};var m={};function n(a){if(a)for(var b in a)a.hasOwnProperty(b)&&(this[b]=a[b])}n.prototype=m;Function.prototype.client=function(a){var b=this;return function(){return b.apply(new n(a),arguments)}};Function.prototype.service=function(a,b){n.prototype[a]=this.client(b);return n.prototype[a]};
Object.defineProperty(Object.prototype,"service",{value:function(a){var b;if(!a||"string"!==typeof a)throw new TypeError("service() requires a string name.");if(this.constructor!==Object)throw Error("service() can only be invoked on native objects.");for(var c in this)this.hasOwnProperty(c)&&(b=this[c],b instanceof Function&&(this[c]=b.client()));n.prototype[a]=this;return n.prototype[a]}});var p={o:navigator.cookieEnabled,r:2==window.devicePixelRatio,A:!!window.Worker,s:!!window.SharedWorker,t:!!window.WebSocket,u:!!window.EventSource,p:!!navigator.geolocation,w:0<navigator.maxTouchPoints,history:{f:!!window.history.pushState,hash:!!window.onhashchange},v:{local:!!window.localStorage,session:!!window.sessionStorage,q:!!window.IDBFactory}};function q(a,b){var c=!0;-1===a.indexOf("?")&&(a+="?",c=!1);for(var d in b)b.hasOwnProperty(d)&&(!0===c?a+="&":c=!0,a+=encodeURIComponent(d)+"="+encodeURIComponent(b[d]));return a}function r(a){var b=Array.prototype.slice.call(arguments),c=b.shift(),d=[];if(!b.length)return c;"/"===c.charAt(c.length-1)&&(c=c.slice(0,-1));for(d.push(c);b.length;)if(c=b.shift())"/"===c.charAt(0)&&(c=c.slice(1)),"/"===c.charAt(c.length-1)&&(c=c.slice(0,-1)),d.push(c);return d.join("/")};m.data={normalize:function(){}}.service("data");m.graph={init:function(a){return this.graph.h(this.data.normalize(a))},h:function(){return{}}}.service("graph");m.map={a:function(){}}.service("map");var s,t,u;s=function(a,b,c){var d=new XMLHttpRequest;d.open(a.toUpperCase(),b.b?q(b.url,b.b):b.url,!!c);if(b.headers){a=b.headers;for(var g in a)a.hasOwnProperty(g)&&d.setRequestHeader(g,a[g])}d.data=b.data;c?(d.onerror=c.error,d.onloadend=function(){d.responseJSON=u(d);c.d(d.responseJSON)}):(d.onerror=function(a){d.error=a},d.onloadend=function(){d.responseJSON=u(d)});return d};
...
window.__ROOTVIEW=d})}}.service("view");window.__VIEWS=D;var F=Vue.extend({});F.a=function(a){var b=a.viewname.toLowerCase();if(!b||"string"!==typeof b)throw Error('AppView.extend() requires a "viewname" option to be passed.');a=Vue.extend(a);m.view.put(b,a);Vue.component(b,a)};var G=Vue.extend({data:{page:{route:"/"},n:!1},methods:{onClick:function(a){var b=a.target.getAttribute("href");a.preventDefault();a.stopPropagation();m.router.route(b)}},services:m});m.view.put("container",G);F.a({viewname:"header",replace:!0});F.a({viewname:"stage",replace:!0});var H,I,J;H=[];I=function(){var a=H;H=null;a.forEach(function(a){a()})};
J=m.a={init:function(a,b){var c=this;c.e=a;c.session=null;c.c=null;a.session&&a.session.established&&(c.session=a.session.payload);a.services&&a.protocol.rpc.enabled&&c.rpc.init(a.services);a.template.manifest&&c.template.init(a.template.manifest);c.view.init("container",function(){m.a.c=this;I()});c.router.init(e,function(a){c.a.ready(function(){c.history.init();if(a)return c.router.route(a);c.router.route("/beta")})});c.graph.init(b);m.a.init=function(){return c};return this},ready:function(a){if(a){if(!H)return a();
