(function() {var e={"/":function(){this.a.c.$set("active",!0);this.a.c.$set("page.route","/");return null},"/login":function(){},"/settings":function(){},"/beta":function(){this.a.c.$set("active",!0);this.a.c.$set("page.route","/beta");return null},"/404":function(){},"/<key>":function(){},"/<key1>/and/<key2>":function(){}};function k(a){if(a&&a.querySelector)return a;if("string"===typeof a){if("#"===a.charAt(0))a=document.getElementById(a.slice(1));else{a=document.querySelectorAll(a);var b=[],c;for(c=0;c<a.length;b.push(a[c++]));a=b}return a}throw new TypeError("Invalid document query string.");};var l={i:JSON.parse(k("#js-context").textContent||"{}"),data:JSON.parse(k("#js-data").textContent||"{}")};var m={};function n(a){if(a)for(var b in a)a.hasOwnProperty(b)&&(this[b]=a[b])}n.prototype=m;Function.prototype.client=function(a){var b=this;return function(){return b.apply(new n(a),arguments)}};Function.prototype.service=function(a,b){n.prototype[a]=this.client(b);return n.prototype[a]};
