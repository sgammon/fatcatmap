...
_onload=this.onload=function $this$onload$($event$$){var $callback$$,$_i$$,$_len$$,$_ref$$,$_results$$;$_ref$$=this.__onload_callbacks;$_results$$=[];$_i$$=0;for($_len$$=$_ref$$.length;$_i$$<$_len$$;$_i$$++)$callback$$=$_ref$$[$_i$$],$_results$$.push($callback$$($event$$));return $_results$$};var browse,catnip,draw,graph_config,map,mapper,_ref,_ref1,_ref2;catnip=this.catnip={};map=this.map=_get("#map");mapper=this.mapper=_get("#mapper");
