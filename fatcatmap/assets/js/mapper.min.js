...
configure=function $configure$(){var $config$$;$config$$={width:this.catnip.el.mapper.offsetWidth,height:this.catnip.el.mapper.offsetHeight,force:{alpha:0.75,strength:1,friction:0.9,theta:0.7,gravity:0.1,charge:-700,distance:150},origin:{snap:!0,dynamic:!0,position:{x:this.catnip.el.mapper.offsetWidth-30,y:this.catnip.el.mapper.offsetHeight-30}},node:{radius:20,classes:"node"},labels:{enable:!1,distance:0},edge:{width:2,stroke:"#999",classes:"link"},sprite:{width:60,height:60,images:{format:this.catnip.context.agent.capabilities.webp&&
...
$_ref1$$[0]:void 0)&&"Rep"||"Sen",state:null!=($_ref2$$=$node$$["native"].data.fecid)?$_ref2$$.slice(2,4):void 0,govtrack_id:$node$$["native"].data.govtrack_id,image_format:this.catnip.config.graph.sprite.images.format,config:$.catnip.config}),$("#leftbar section.content").html(rendered_detail));console.log("Showing detail for node...",$node$$,$rendered$$);if($.catnip.el.leftbar.classList.contains("collapsed"))return $.catnip.ui.expand($.catnip.el.leftbar)};
