...
_onload=this.onload=function $this$onload$($event$$){var $callback$$,$_i$$,$_len$$,$_ref1$$,$_results$$;$_ref1$$=this.catnip.events.onload;$_results$$=[];$_i$$=0;for($_len$$=$_ref1$$.length;$_i$$<$_len$$;$_i$$++)$callback$$=$_ref1$$[$_i$$],$_results$$.push($callback$$($event$$));return $_results$$};var browse,configure,detail,draw;
configure=function $configure$(){var $config$$;$config$$={width:this.catnip.el.mapper.offsetWidth,height:this.catnip.el.mapper.offsetHeight,force:{alpha:.75,strength:1,friction:.9,theta:.7,gravity:.1,charge:-700,distance:150},origin:{snap:!0,dynamic:!0,position:{x:this.catnip.el.mapper.offsetWidth-30,y:this.catnip.el.mapper.offsetHeight-30}},node:{radius:20,classes:"node"},labels:{enable:!1,distance:0},edge:{width:2,stroke:"#999",classes:"link"},sprite:{width:60,height:60,images:{format:this.catnip.context.agent.capabilities.webp&&
"webp"||"jpeg"}}};return this.catnip.config.graph=$config$$};
detail=this.detail=this.catnip.graph.detail=function $this$catnip$graph$detail$($node$$){var $rendered$$,$_ref$$,$_ref1$$,$_ref2$$;null!=$node$$["native"].data.firstname&&($rendered$$=$.apptools.templates.get("tpl-legislator").render({key:$node$$.node.key,"class":"node-detail",firstname:$node$$["native"].data.firstname,lastname:$node$$["native"].data.lastname,office:"H"===(null!=($_ref$$=$node$$["native"].data.fecid)?$_ref$$[0]:void 0)&&"Representative"||"Senator",title:"H"===(null!=($_ref1$$=$node$$["native"].data.fecid)?
$_ref1$$[0]:void 0)&&"Rep"||"Sen",state:null!=($_ref2$$=$node$$["native"].data.fecid)?$_ref2$$.slice(2,4):void 0,govtrack_id:$node$$["native"].data.govtrack_id,image_format:$.catnip.config.graph.sprite.images.format,portrait_size:"200px",config:$.catnip.config}),$("#leftbar section.content").html($rendered$$));console.log("Showing detail for node...",$node$$,$rendered$$);if($.catnip.el.leftbar.classList.contains("collapsed"))return $.catnip.ui.expand($.catnip.el.leftbar)};
browse=this.browse=this.catnip.graph.browse=function $this$catnip$graph$browse$($node$$){console.log("Browsing to origin...",$node$$);return $.apptools.api.graph.construct({origin:$node$$.node.key}).fulfill({success:function($response$$){return receive($response$$)}})};
draw=this.draw=this.catnip.graph.draw=function($_this$$0$$){return function($_graph$$){var $config$$,$force$$,$_load$$,$_resize$$;console.log("Drawing materialized graph.",$_graph$$);if(null==$_this$$0$$.catnip.graph.active)return $_this$$0$$.catnip.config.graph=configure(),$_this$$0$$.catnip.graph.active=$_graph$$,$config$$=$_this$$0$$.catnip.config.graph,$_this$$0$$.d3.scale.category20(),$force$$=$_this$$0$$.catnip.graph.force=$_this$$0$$.d3.layout.force().size([$config$$.width,$config$$.height]).linkDistance($config$$.force.distance).charge($config$$.force.charge).linkStrength($config$$.force.strength).friction($config$$.force.friction).theta($config$$.force.theta).gravity($config$$.force.gravity).alpha($config$$.force.alpha),
$_resize$$=function $$_resize$$$(){var $height$$,$width$$;$width$$=this.innerWidth||document.body.clientWidth||document.documentElement.clientWidth;$height$$=this.innerHeight||document.body.clientHeight||document.documentElement.clientHeight;this.catnip.config.graph.width=$width$$;this.catnip.config.graph.height=$height$$;this.catnip.graph.root.attr("width",$width$$).attr("height",$height$$);return this.catnip.graph.force.size([$config$$.width,$config$$.height]).resume()},$_load$$=function $$_load$$$($g$$,
$edge_edge_wrap_node$$4_node_wrap_w$$,$h$$){var $container$$,$label_force$$,$line$$,$line_tick$$,$node_tick$$,$svg$$,$_consider_district__e$$,$_edge_labels$$,$_i$$11__j$$,$_label__len1$$,$_len$$11__ref1$$,$_n$$,$_node_labels$$,$_ref$$,$_title_postfix$$;$svg$$=this.catnip.graph.root=this.d3.select(this.map);if($config$$.labels.enable){$_node_labels$$=[];$_edge_labels$$=[];$_ref$$=$g$$.nodes;$_i$$11__j$$=0;for($_len$$11__ref1$$=$_ref$$.length;$_i$$11__j$$<$_len$$11__ref1$$;$_i$$11__j$$++)$_n$$=$_ref$$[$_i$$11__j$$],
$_label__len1$$=[],null!=$_n$$["native"].data.fecid||null!=$_n$$["native"].data.govtrack_id?null!=$_n$$["native"].data.fecid?($_consider_district__e$$=!1,"H"===$_n$$["native"].data.fecid[0]?($_label__len1$$.push("Rep."),$_consider_district__e$$=!0):"S"===$_n$$["native"].data.fecid[0]?$_label__len1$$.push("Sen."):"P"===$_n$$["native"].data.fecid[0]&&$_label__len1$$.push("President"),$_label__len1$$.push($_n$$["native"].data.firstname),$_label__len1$$.push($_n$$["native"].data.lastname),$_title_postfix$$=
$_n$$["native"].data.fecid.slice(2,4),$_consider_district__e$$&&($_title_postfix$$+="-"+$_n$$["native"].data.fecid.slice(4,6)),$_label__len1$$.push("["+$_title_postfix$$+"]"),$_node_labels$$.push({node:$_n$$,label:$_label__len1$$.join(" ")})):(console.warn("Missing FECID for Legislator node.",$_n$$),$_node_labels$$.push({node:$_n$$,label:""})):null!=$_n$$["native"].data.contributor_type?$_node_labels$$.push({node:$_n$$,label:$_n$$["native"].data.name}):console.error("Unidentified object.",$_n$$);
$_len$$11__ref1$$=$g$$.edges;$_i$$11__j$$=0;for($_label__len1$$=$_len$$11__ref1$$.length;$_i$$11__j$$<$_label__len1$$;$_i$$11__j$$++)$_consider_district__e$$=$_len$$11__ref1$$[$_i$$11__j$$],$_edge_labels$$.push({edge:$_consider_district__e$$,label:"contribution",source:$_consider_district__e$$.source,target:$_consider_district__e$$.target});$label_force$$=this.catnip.graph.label_force=this.d3.layout.force().nodes($_node_labels$$).links($_edge_labels$$).gravity(0).linkDistance(0).linkStrength(8).charge(-100).size([$edge_edge_wrap_node$$4_node_wrap_w$$,
$h$$])}$edge_edge_wrap_node$$4_node_wrap_w$$=this.catnip.graph.edge_wrap=$svg$$.selectAll(".edge").data($g$$.edges).enter();$edge_edge_wrap_node$$4_node_wrap_w$$=this.catnip.graph.edge=$edge_edge_wrap_node$$4_node_wrap_w$$.append("svg:svg").attr("id",function($e$$){return"edge-"+$e$$.edge.key});$line$$=this.catnip.graph.line=$edge_edge_wrap_node$$4_node_wrap_w$$.append("svg:line").attr("stroke",$config$$.edge.stroke).attr("class",$config$$.edge.classes).style("stroke-width",$config$$.edge.width);
$edge_edge_wrap_node$$4_node_wrap_w$$=this.catnip.graph.node_wrap=$svg$$.selectAll(".node").data($g$$.nodes).enter();$container$$=this.catnip.graph.node_container=$edge_edge_wrap_node$$4_node_wrap_w$$.append("svg:svg").attr("id",function($n$$){return"group-"+$n$$.node.key}).attr("width",$config$$.sprite.width).attr("height",$config$$.sprite.height).on("dblclick",this.catnip.graph.browse).on("click",this.catnip.graph.detail).call($force$$.drag);$edge_edge_wrap_node$$4_node_wrap_w$$=this.catnip.graph.node=
$container$$.append("svg:g").attr("width",$config$$.sprite.width).attr("height",$config$$.sprite.height).attr("class",function($d$$,$i$$){var $classList$$;$classList$$=["node-group"];null!=$d$$["native"].data.govtrack_id?($classList$$.push("legislator"),$classList$$.push("M"===$d$$["native"].data.gender&&"male"||"female"),$classList$$.push(parseInt(100*Math.random()%2)&&"democrat"||"republican")):($classList$$.push("contributor"),$classList$$.push("C"===$d$$["native"].data.contributor_type&&"corporate"||
"individual"));return $classList$$.join(" ")});this.catnip.graph.circle=$edge_edge_wrap_node$$4_node_wrap_w$$.append("svg:circle").attr("r",$config$$.node.radius).attr("cx",$config$$.sprite.width/2).attr("cy",$config$$.sprite.height/2).attr("class",$config$$.node.classes);this.catnip.graph.legislator_image=$edge_edge_wrap_node$$4_node_wrap_w$$.append("svg:image").filter(function($n$$){return null!=$n$$["native"].data.govtrack_id}).attr("width",$config$$.sprite.width).attr("height",$config$$.sprite.height).attr("clip-path",
"url(#node-circle-mask)").attr("xlink:href",function($_this$$){return function($n$$){return $_this$$.catnip.config.assets.prefix+"image-proxy/providence-clarity/warehouse/raw/govtrack/photos/"+$n$$["native"].data.govtrack_id.toString()+"-"+($_this$$.catnip.context.agent.capabilities.retina&&"200px"||"100px")+"."+$config$$.sprite.images.format}}(this));$config$$.labels.enable&&($svg$$.selectAll(".ghost-edge.label").data($_edge_labels$$),$svg$$.selectAll(".ghost-node.label").data($label_force$$.nodes()).enter().append("svg:g").attr("id",
function($d$$,$i$$){return"anchor-"+$d$$.node.node.key}).attr("class","anchor-node").append("svg:circle").attr("r",0).style("fill","#FFF").append("svg:text").text(function($d$$,$i$$){return $d$$.label||""}).style("fill","#555").style("font-family","Arial").style("font-size",12));window.onresize=$_resize$$;$line_tick$$=function($_this$$){return function($direction$$,$point$$,$edge_data$$,$edge_i$$){return $config$$.origin.snap&&$edge_data$$[$direction$$].index===graph.origin?Math.floor($config$$.origin.position[$point$$]):
Math.floor($edge_data$$[$direction$$][$point$$]+$config$$.node.radius/2)}}(this);$node_tick$$=function($_this$$){return function($point$$,$node_data$$,$node_i$$){return $config$$.origin.snap&&$node_i$$===graph.origin?Math.floor($config$$.origin.position[$point$$]-$config$$.sprite["x"===$point$$&&"width"||"height"]/2):Math.floor($node_data$$[$point$$]-$config$$.node.radius)}}(this);$force$$.on("tick",function($_this$$){return function($_k$$){var $_len2$$,$point$$,$_ref2$$,$_results$$;$_k$$=$config$$.width/
2;$_len2$$=$config$$.height/2;$config$$.origin.dynamic&&$config$$.origin.snap&&($config$$.origin.position={x:$_k$$+$config$$.sprite.width/2,y:$_len2$$+$config$$.sprite.height/2});$config$$.labels.enable&&$label_force$$.start();$_ref2$$=["x","y"];$_k$$=0;for($_len2$$=$_ref2$$.length;$_k$$<$_len2$$;$_k$$++)$point$$=$_ref2$$[$_k$$],$container$$.attr($point$$,function($d$$,$i$$){return $node_tick$$($point$$,$d$$,$i$$)});$_ref2$$=["x1","y1","x2","y2"];$_results$$=[];$_k$$=0;for($_len2$$=$_ref2$$.length;$_k$$<
$_len2$$;$_k$$++)$point$$=$_ref2$$[$_k$$],$_results$$.push($line$$.attr($point$$,function($d$$,$i$$){return $line_tick$$("1"===$point$$[1]&&"source"||"target",$point$$[0],$d$$,$i$$)}));return $_results$$}}(this));return $force$$.nodes($g$$.nodes).links($g$$.edges).start()||$force$$},console.log("Drawing graph...",$_graph$$),setTimeout(function(){return $_load$$(graph)},150);console.log("Incremental draw...",graph);return setTimeout(function(){$_this$$0$$.catnip.ui.hide($_this$$0$$.map);$_this$$0$$.catnip.el.map.textContent=
"";$_this$$0$$.catnip.graph.draw(graph);return setTimeout(function(){return $_this$$0$$.catnip.ui.show($_this$$0$$.map)},250)},0)}}(this);
